...
EOF
    ...
    eksctl create cluster --name=${AWS_PROJECT}fargate --fargate --tags Key=${TAGKEY0},Value=${TAGVALUE0}
    #aws eks tag-resource --resource-arn ${AWS_PROJECT}fargate --tags Key=${TAGKEY0},Value=${TAGVALUE0} Key=${TAGKEY1},Value=${TAGVALUE1} Key=${TAGKEY2},Value=${TAGVALUE2}  #EKS cluster with Fargate profile
